...
<html>
<head>
<title>Rental a Real Estates and Builders Category Flat bootstrap Responsive website Template | Single-page :: w3layouts</title>
<!--mobile apps-->
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-copy">
				<p>© 2016 Rental. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
			</div>
		</div>
	</div>
	<!--//footer-->
